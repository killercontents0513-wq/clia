"""
SH5A 크롤 (v6_20 의 SHSA 항목 수정)
- id: SHSA → SH5A (코드 오타 수정)
- 갤러리: basic + zoom-01~10 (11장) in /speakers/soundbars/sh5a/
- 피처: 4장 desktop (feature-desktop-02/03/07/08)
- 스펙: Key Features 기반 12개 (c-compare-selling 없음)
"""
...
# ── 갤러리: basic + zoom-01~10 (11장) ─────────────────────────────────────
GAL_BASE  = '/speakers/soundbars/sh5a/'
GAL_PATHS = [GAL_BASE + 'soundbar-sh5a-2025-gallery-basic.jpg'] + \
            [GAL_BASE + f'soundbar-sh5a-2025-gallery-zoom-{str(i).zfill(2)}.jpg' for i in range(1, 11)]

# ── 피처 (4장 — 실제 페이지 h2/h3 텍스트 기반) ──────────────────────────────
FEAT_BASE = '/speakers/soundbars/features/'
FEAT_LIST = [
    (FEAT_BASE + 'soundbar-sh5a-2025-feature-desktop-03.jpg',
     '600W 4.1ch', '600 Watts 4.1ch — Space Dominating Sound',
     'Powerful 600W output across 4.1 channels fills every corner of your room with rich, full sound.'),
    (FEAT_BASE + 'soundbar-sh5a-2025-feature-desktop-02.jpg',
     'AI Sound Pro', 'AI Sound Pro — Intelligent Multi-Surround',
     'AI Sound Pro with Dolby Digital and DTS Surround analyzes your content and optimizes audio automatically.'),
    (FEAT_BASE + 'soundbar-sh5a-2025-feature-desktop-07.jpg',
     'WOW Orchestra', 'WOW Orchestra — TV and Soundbar Synchronized',
     'WOW Orchestra synchronizes your LG TV speakers with the soundbar for a seamlessly immersive audio experience.'),
    (FEAT_BASE + 'soundbar-sh5a-2025-feature-desktop-08.jpg',
     'ThinQ App', 'Smart Control with LG ThinQ App',
     'Connect and control your soundbar from your smartphone — adjust volume, change sound modes, and more.'),
]
...
SPECS = {
    ...
    'Dolby_Digital':    'Yes',
    'DTS_Surround':     'Yes',
    'HDMI_ARC':         'Yes (Out only)',
    'Optical':          'Yes',
    'Bluetooth':        'Yes',
    'USB':              'Yes',
    'WOW_Orchestra':    'Yes',
    'WOW_Interface':    'Yes',
    'ThinQ_App':        'Yes (iOS / Android)',
    'Model':            NEW_CODE,
}
...
entry_new=replace_str_field(entry_new,'nm','LG Soundbar SH5A 4.1ch 600W with WOW Orchestra')
entry_new=replace_str_field(entry_new,'pr','699')
entry_new=replace_str_field(entry_new,'url','https://www.lg.com/sa_en/speakers/soundbars/sh5a/')
